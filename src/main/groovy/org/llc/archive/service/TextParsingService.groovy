...
class TextParsingService {
    ...
    private static final Logger logger = LoggerFactory.getLogger(TextParsingService.class)

    static String parseFilename(String basePath, String absoluteFilePath) {
    ...
    static String parseMinister(String artist) {
        if (!artist) {
            return ''
        }
    ...
    static String parseBibleText(String album) {
        return album ?: ""
    }

    static String parseTime(String title) {
        String time = ""
    ...
    static String parseDate(String title, String name) {
        String date = ""
    ...
    static String formatDate(int month, int day, int year) {
        String date
    ...
    static String parseNotes(String comment) {
