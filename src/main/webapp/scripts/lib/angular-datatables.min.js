...
!function (a, b, c, d) {
    ...
    function j(a, b, d, e) {
        ...
        function g() {
            e.warn('"DTInstances.getLast()" and "DTInstances.getList()" are deprecated! Use the "dt-instance" to provide the datatables instance. See https://l-lin.github.com/angular-datatables/#/manipulatingDTInstances for more information.');
            var c = a.defer();
            return n || (m = a.defer(), n = m.promise), b(n).then(function (a) {
                c.resolve(a), m = null, n = null
            }, function () {
                c.resolve(l)
            }), c.promise
        }
        ...
        function h() {
            e.warn('"DTInstances.getLast()" and "DTInstances.getList()" are deprecated! Use the "dt-instance" to provide the datatables instance. See https://l-lin.github.com/angular-datatables/#/manipulatingDTInstances for more information.');
            var c = a.defer();
            return p || (o = a.defer(), p = o.promise), b(p).then(function (a) {
                c.resolve(a), o = null, p = null
            }, function () {
                c.resolve(k)
            }), c.promise
        }
        ...
        var j = 1e3, k = {}, l = {}, m = null, n = null, o = null, p = null;
    ...
    function q(a, b, c, d, e, f, g, h) {
        function i(i) {
            function j(a, c, e) {
                ...
                var i = b.defer(), j = a.find("tbody").html(), k = j.match(/^\s*.+?\s+in\s+(\S*)\s*/m);
    ...
    function r(a, b, c, e, f, g, h) {
        function i(i) {
            ...
            function k(a, b) {
                ...
                d.isFunction(v.options.fnPromise) ? n(v.options.fnPromise, q).then(function (c) {
            ...
            function q() {
                return r.clear(), r.rows.add(i.aaData).draw(i.redraw), {
                    id: t.id,
    ...
    function v(a, b) {
        ...
        return function (d, e) {
            var f = a.defer(), g = e || c;
            return b(function () {
                f.reject("Not resolved within " + g)
            }, g), a.when(d).then(function (a) {
                f.resolve(a)
            }, function (a) {
                f.reject(a)
            }), f.promise
