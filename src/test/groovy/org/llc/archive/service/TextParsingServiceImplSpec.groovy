...
//        'Tapani Kinnunen'                       || 'Tapani Kinnunen'
    ...
    def "Parse Minister From Filename #filename"() {
        ...
        '2015/20150814_AHarju.mp3'                                || 'Arthur Harju'
        '2015/20150815_CSimonson.mp3'                             || ''
        '2015/20150816_AHarju.mp3'                                || 'Arthur Harju'
        ...
        '20151115 Arthur Simonson.mp3'                            || ''
        '20151115 Jari Warwaruk.mp3'                              || ''
        '20151129 Dave Anderson.mp3'                              || ''
        '20151129 Wayne Kallio.mp3'                               || ''
        '20151206 Jari Warwaruk.mp3'                              || ''
        '20151213 Bob Haapala.mp3'                                || ''
        '20151224 Wayne Kallio.mp3'                               || ''
        '20151225 Bob Haapala.mp3'                                || ''
        '20151227 Stan Ylioja.mp3'                                || ''
        '20151231 Mel Kallio.mp3'                                 || ''
        '2016/0110_PHuhta.mp3'                                    || 'Phillip Huhta'
        '2016/0117MPasanen.mp3'                                   || ''
        '20160103 Jari Warwaruk.mp3'                              || ''
        '20160103 Stan Ylioja.mp3'                                || ''
        '20160110 Bob Haapala.mp3'                                || ''
    }
